	...
	public VentanaInicio() {
		...
		menuACliente.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				aCliente.setBounds(30, 30, 930, 530);
				aCliente.repaint();
				add(aCliente);
				aCliente.repaint();
		...
		menuConsulta.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				Consulta = v.c1.ConsultarTabla(true);
				Consulta.setBounds(30, 30, 930, 530);
				Consulta.repaint();
				add(Consulta);
				Consulta.repaint();
				...
				Consulta.addMouseListener(new MouseListener() {
					...
					@Override
					public void mouseExited(MouseEvent arg0) {
						Consulta.setBackground(new Color(242, 243, 244));
		...
		menuECliente.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				eCliente.setBounds(30, 30, 930, 530);
				eCliente.repaint();
				add(eCliente);
				eCliente.repaint();
		...
		menuMCliente.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				mCliente.setBounds(30, 30, 930, 530);
				mCliente.repaint();
				add(mCliente);
				mCliente.repaint();
